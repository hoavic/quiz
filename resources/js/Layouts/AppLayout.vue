            ...
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink :href="route('takes.index')" :active="route().current('takes.index')">
                                    Takes
                                </NavLink>
                                ...
                                <NavLink :href="route('taxonomies.index')" :active="route().current('taxonomies.*')">
                                    Taxonomies
                                </NavLink>
                            </div>
                        </div>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink :href="route('takes.index')" :active="route().current('takes.index')">
                            Takes
                        </ResponsiveNavLink>
